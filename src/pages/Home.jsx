  ...
  return (
    <div className='bg-gradient-to-r from-[#8CD23C] to-[#417A00]'>
      ...
      <div className="z-10 fixed bottom-10 left-1/2 -translate-x-1/2">
        <button onClick={() => setFloatingButton(prev => !prev)} className={`relative shadow-[0_0_12px_0_#77AC63] size-14 text-white flex justify-center items-center rounded-full bg-gradient-to-r from-[#8CD23C] to-[#417A00] backdrop-blur-md ease-in-out duration-300 ${floatingButtonIsOpen && 'scale-150 shadow-xl'}`}>
          {/* <GoPlus className={`mx-auto text-2xl stroke-1 duration-300 ease ${floatingButtonIsOpen && 'rotate-45'}`} /> */}
          <FaCartShopping className="absolute bottom-[45%] right-1/2" />
          <div className="w-[2px] h-8 bg-white rounded-full rotate-45"></div>
          <FaBellConcierge className="absolute top-[45%] left-1/2" />
        </button>
