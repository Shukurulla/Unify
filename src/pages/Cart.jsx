        ...
        <div className='sticky bottom-0 bg-[#EDF2F6] p-4 flex flex-col gap-4 rounded-tl-3xl w-full'>
            ...
            <ul className='font-bold'>
                ...
                <li className='flex justify-between'>
                    ...
                    <span className='bg-gradient-to-r from-[#8CD23C] to-[#417A00] bg-clip-text text-transparent opacity-70'>0</span>
                </li>
                <li className='flex justify-between'>
                    <span>Jámi:</span>
                    <span className='bg-gradient-to-r from-[#8CD23C] to-[#417A00] bg-clip-text text-transparent'>{totalPrice}</span>
